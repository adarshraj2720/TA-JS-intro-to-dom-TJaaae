...
let topics= document.querySelectorAll('ul')
...
==allTopics.forEach((txt) => console.log(txt.innerText));
...
// 23. Select the previous element sibling of the element stored in `topics` variable (#5) and change the `innerText` property to `Learning About Walking the DOM`.
 element.previousElementSibling.innerText = "Learning About Walking the DOM";
// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
element.firstElementChild.innerText = "This is the first child element";
