...
for(let hrs of allHrsArray){
  hrs.style.background = "antiquewhite";
 }

 allHrs.forEach(elm =>elm.style.backgroundColor="antiquewhite")
// Change the 'border-radius' of all the hr to "5px" using array.

for(let radius of allHrsArray){
  radius.style.borderRadius = "5px";
 }
...
allHrs.style.border="1px dashed tomatao"
...
//p.innerText="Append inserts as last" - aise v  hoga 
let text=document.createTextNode("Append inserts as last")
p.append(text)
box2.append(p)
